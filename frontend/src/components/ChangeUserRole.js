...
const ChangeUserRole = ({
  ...
  //handling the change in role by admin such that; that change also reflects in the database
  ...
  return (
    <div className='fixed top-0 bottom-0  left-0 right-0  w-full h-full z-10 flex justify-center items-center bg-slate-200 bg-opacity-50'>
      <div className='mx-auto bg-white shadow-md p-4 w-full max-w-sm'>
        <button className='block ml-auto font-medium' onClick={onClose}><IoIosClose/></button>
